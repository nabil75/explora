...
export class FermeeMultipleComponent implements OnInit {
  ...
  @ViewChild('modalite', { read: ViewContainerRef })
  ...
  remove_question(idComponent:number){
    this.eventEmitterService.onFirstComponentQuestionClick(idComponent);
  }
  ...
  add_modalite_simple(){
    // const modaliteComponentFactory = this.componentFactoryResolver.resolveComponentFactory(ModaliteSimpleComponent);
  ...
  add_modalite_autre(){
    ...
    // const componentFactory = this.componentFactoryResolver.resolveComponentFactory(ModaliteAutreComponent);
  ...
  add_modalite_nsp(){
    // Create an instance of the dynamic component
    // const componentFactory = this.componentFactoryResolver.resolveComponentFactory(ModaliteNspComponent);
  ...
  add_modalite_nc(){
    // Create an instance of the dynamic component
    // const componentFactory = this.componentFactoryResolver.resolveComponentFactory(ModaliteNcComponent);
